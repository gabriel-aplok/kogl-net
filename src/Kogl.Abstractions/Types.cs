...
public struct TextureSet : IEquatable<TextureSet>
{
    ...
    public override readonly bool Equals(object? obj) => obj is TextureSet other && Equals(other);

    public override readonly int GetHashCode() =>
        HashCode.Combine(Slot0, Slot1, Slot2, Slot3, Slot4, Slot5, Slot6, Slot7);
